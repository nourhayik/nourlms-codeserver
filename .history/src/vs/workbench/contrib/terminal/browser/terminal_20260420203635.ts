...
export interface ITerminalInstance extends IBaseTerminalInstance {
	...
	/** NourLMS: when true the terminal blocks keyboard input. */
	nourlmsReadOnly: boolean;
	/** NourLMS: when true input is temporarily allowed (during code execution). */
	nourlmsAllowInput: boolean;
