...
suite('Labels', () => {
	...
	test('template', () => {
		...
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: '', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), 'NourLMS Code Server');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'Untitled-1', rootName: '', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), 'Untitled-1 - NourLMS Code Server');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), 'monaco - NourLMS Code Server');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), 'somefile.txt - monaco - NourLMS Code Server');
		assert.strictEqual(labels.template(t, { dirty: '* ', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), '* somefile.txt - monaco - NourLMS Code Server');

		// real world example (other)
		t = '${dirty}${activeEditorShort}${separator}${rootNameShort}${separator}${appName}';
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco (Workspace)', rootNameShort: 'monaco', appName: 'NourLMS Code Server', separator: { label: ' - ' } }), 'monaco - NourLMS Code Server');
	});
